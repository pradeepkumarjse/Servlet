...
public class JobSeekerRegistrationServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		pw.println("<h1 style='color:green;text-align:center'>The fllowing Files are uploaded succefully </h1>");
        ...
        pw.println("<h1 style='color:cyan;tex-align:center'>Uploaded files are :"+resumeFileName+" : "+photoFileName+"</h1>");
        ...
        //write these details to db table as record
           ...
           //set values to query params
              ...
              ps.setString(4, "D:/store/"+resumeFileName);
              ps.setString(3, "D:/store/"+photoFileName);
              //execute the query
            ...
            //process the results
              if(count==0)
            	  ...
            	  pw.println("<h1 style='text-align:center;color:green'> JobSeeker registration succeded </h1>");
		}//try
		...
		pw.println("<br><br><h1 style='color:belue;align:center;'>  <a href='register.html'>Home</a></h1>");
	}//doGet(-,-)
